      ...
      {currentUser ? (
        ...
        >
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav.Link className="link-light" onClick={handleHome}>
              Opțiuni universitare
            </Nav.Link>
            <Nav.Link className="link-light" onClick={handleQuiz}>
              Chestionar de orientare în carieră
            </Nav.Link>
            <Nav.Link className="link-light" onClick={handleChats}>
              Camere de chat
            </Nav.Link>
        ...
        >
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav.Link className="link-light" onClick={handleLogin}>
              Intră în cont
            </Nav.Link>
            <Nav.Link className="link-light" onClick={handleSignup}>
              Creează un cont
            </Nav.Link>
            )
          </Navbar.Collapse>
